...
def add_chat_handlers(dp):
    ...
    dp.add_handler(CommandHandler(CMDS['common']['music']['name'], music_handler, filters=cmd_filter))
    dp.add_handler(CommandHandler(CMDS['hidden']['musicadd']['name'], musicadd_handler, filters=cmd_filter))
    dp.add_handler(CommandHandler(CMDS['hidden']['musicdel']['name'], musicdel_handler, filters=cmd_filter))
