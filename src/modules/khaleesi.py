...
class Khaleesi:
    ...
    @classmethod
    def is_its_time_for_khaleesi(cls, chat_id):
    ...
    @classmethod
    def increase_khaleesi_time(cls, chat_id):
    ...
    @classmethod
    def is_good_for_khaleesi(cls, orig_line):
        """
    ...
    @staticmethod
    def __get_base_cache_key(chat_id: int, tail: str, date: typing.Optional[datetime]=None) -> str:
